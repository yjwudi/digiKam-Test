...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        point_transform (
            const double& angle,
            const dvector<double,2>& translate_
        )
        {
            sin_angle = std::sin(angle);
            cos_angle = std::cos(angle);
        ...
        ) const
        {
            ...
            return dvector<double,2>(x,y) + translate;
        }
...
// ----------------------------------------------------------------------------------------
    ...
    inline point_transform_projective find_projective_transform (
        const std::vector<dvector<double,2> >& from_points,
        const std::vector<dvector<double,2> >& to_points
    )
    {
...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        point_transform_affine3d (
            const matrix<double,3,3>& m_,
            const dvector<double,3>& b_
        ) :m(m_), b(b_)
        {
        }

        const dvector<double,3> operator() (
            const dvector<double,3>& p
        ) const
        {
            return m*p + b;
        }
