...
Fisherfaces::Fisherfaces(string trainf, string testf)
{
    ifstream in;
...
void Fisherfaces::predict() const
{
    int i, sum = 0;
...
Mat Fisherfaces::asRowMatrix(vector<Mat> src, int rtype, double alpha, double beta) {
